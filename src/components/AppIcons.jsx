    ...
    {appIconToggle && (
      ...
      >
        <div className="search_wrap">
          <input
            ...
            type="text"
            placeholder={t('appIcons.searchPlaceholder')}
            value={search}
              ...
              <div className={`appicon_grid${isSearching ? " searching" : ""}`}>
                {pageItems.length > 0 ? pageItems.map(icon => (
                  ...
                  <div className="no_results">
                    <p>{t('appIcons.noResults')}</p>
                    <small>{t('appIcons.noResultsHint')}</small>
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="statusbar">
        <span className="statusbar_text">
          {activeId ? t('appIcons.moving', { id: activeId }) : t('appIcons.items', { count: visible.length })}
        </span>
        {totalPages > 1 && (
