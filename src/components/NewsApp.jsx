...
function NewsApp() {
    ...
    function getUserLocation() {
        navigator.geolocation.getCurrentPosition(
            ...
            () => setError(t('newsApp.locationDenied'))
        );
    }
    ...
    function fetchWeatherAndCity(lat, lon) {
        ...
        fetch(weatherUrl)
            ...
            .catch(() => setError(t('newsApp.fetchError')));
        ...
        fetch(geoUrl, {
            ...
            .then((data) => {
                ...
                const cityName = address.city || address.town || address.village || address.state || t('newsApp.unknown');
                setCity(cityName);
                localStorage.setItem('city', JSON.stringify(cityName));
            })
            .catch(() => setCity(t('newsApp.unknown')));
    }
                            ...
                            <div className="weather_container">
                                ...
                                <h1>{weatherIcons[weather.code] || ''}
                                    ...
                                    >
                                        ...
                                        {Cel? t('newsApp.fahrenheit'):t('newsApp.celsius')}
                                    </span>
                                </h1>
                            </div>
                        )}
