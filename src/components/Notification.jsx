  ...
  function newNotification(message) {
    ...
    switch (type) {
      case 'msn':
        return {
          img,
          text1: t('notification.newMessage'),
          text2: '',
          function: 'MSN',
        };
      case 'appInstalling':
        return {
          img,
          text1: t('notification.installing', { app: safeName }),
          text2: '',
          function: '',
        };
      case 'appInstalled':
        return {
          img,
          text1: t('notification.installed', { app: safeName }),
          text2: '',
          function: safeName,
        };
      case 'unIntallingApp':
        return {
          img,
          text1: t('notification.uninstalling', { app: safeName }),
          text2: '',
          function: '',
        };
      case 'appUninstalled':
        return {
          img,
          text1: t('notification.uninstalled', { app: safeName }),
          text2: '',
          function: '',
        };
      default:
        return {
          img: icon_wins95,
          text1: t('notification.welcome'),
          text2: t('notification.welcomeSub'),
          function: '',
        };
    }
  }
