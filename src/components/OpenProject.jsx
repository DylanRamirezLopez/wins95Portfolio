...
function OpenProject() {
  ...
  function handleFetchLinkDes(projectName) {
    ...
    case 'AiAgent': 
        return 'https://tomatitomkk.github.io/AI_chatbot/';

    case '3dObject': 
        return 'https://tomatitomkk.github.io/3d_book/'; 
        

    case 'Fortune': 
        return 'https://tomatitomkk.github.io/week_fortune/';


    case 'PixelPic': 
        return 'https://tomatitomkk.github.io/Pixel_pic/'; 
      ...
      >
        <div className='folder_folder-open-project' 
          ...
          >
            <div className="folder_barname">
              <img src={ie} alt="ie" style={{ width: '20px'}} />
                <span>
                    {projectname() === 'Www' ? t('openProject.title') : projectname()}
                </span>
              </div>
          ...
          <div className="file_edit_container">
              <p>{t('openProject.file')}<span style={{left: '-23px'}}>_</span></p>
              <p>{t('openProject.edit')}<span style={{left: '-24px'}}>_</span></p>
              <p>{t('openProject.view')}<span style={{left: '-32px'}}>_</span></p>
              <p>{t('openProject.help')}<span style={{left: '-30px'}}>_</span></p>
          </div>
          <div className="address_container_btn">
            ...
            >
              ...
              <p>{t('openProject.home')}</p>
            </div>
            
          </div>
          <div className="address_container">
            <p className='address'>{t('openProject.address')}</p>
            <div className="address_box">
                <p>{projectUrl.length > 1 ? projectUrl : t('openProject.urlPlaceholder')}</p>
                <div 
