...
function BTC() {
  ...
  const high = !detail ? t('btc.loading') : Math.floor(detail?.high_24h).toLocaleString()
  const low = !detail ? t('btc.loading') : Math.floor(detail?.low_24h).toLocaleString()
          ...
          <div className="btc_content">
            <div className="btc_price_section">
              <div className="btc_price_header">
                ...
                <span className="btc_symbol">{t('btc.btcUsd')}</span>
              </div>
              <div className="btc_price_main">
                <span className="btc_price">{formattedPrice || t('btc.loading')}</span>
            ...
            <div className="btc_stats_section">
              ...
              <div className="btc_stat_row">
                <div className="btc_stat_item">
                  <span className="btc_stat_label">{t('btc.vol')}</span>
              ...
              <div className="btc_stat_row">
                <div className="btc_stat_item">
                  <span className="btc_stat_label">{t('btc.high')}</span>
                ...
                <div className="btc_stat_row">
                <div className="btc_stat_item">
                  <span className="btc_stat_label">{t('btc.low')}</span>
            ...
            >
              <p>{showChart ? t('btc.hideChart') : t('btc.showChart')}</p>
            </div>
