...
import '../styles/ResumeFolder.css'
      ...
      >
        <div className='folder_folder' 
          ...
          <div className="file_edit_container">
              <p>{t('common.file')}<span style={{left: '-23px'}}>_</span></p>
              <p>{t('common.edit')}<span style={{left: '-24px'}}>_</span></p>
              <p>{t('common.view')}<span style={{left: '-32px'}}>_</span></p>
              <p>{t('common.help')}<span style={{left: '-30px'}}>_</span></p>
          </div>
          ...
          <div className="btm_bar_container">
            <div className="object_bar"><p>{TypeExpand.item_1Focus ? `1 ${t('common.objectsSelected')}` : `1 ${t('common.objects')}`}</p></div>
