...
import '../styles/RightClickWindows.css';
    ...
    <>
      {popUpCreateFolderName && (
        <div className="pop_up_create">
          <p>{t('rightClick.enterFolderName')}</p>
          <input type="text" 
        ...
        >  
          {sortExpand && (
            ...
            >{t('rightClick.taskManager')}</p>
            <h5></h5>
            <p style={{color: '#8a8989'}}>{t('rightClick.paste')}</p>
            <p style={{color: '#8a8989'}}>{t('rightClick.pasteShortcut')}</p>
            <p 
              onClick={() => {
                refreshed()
                iconFocusIcon('')
      ...
      >  
          ...
          <p style={{paddingLeft: '25px'}}>{t('rightClick.edit')}</p>
          <h5></h5>
          <p>
            {t('rightClick.sendTo')}
            <span>
          ...
          <h5></h5>
          <p style={{color: '#8a8989'}}>{t('rightClick.cut')}</p>
          <p style={{color: '#8a8989'}}>{t('rightClick.copy')}</p>
          <h5></h5>
          <p
            onClick={() => {
              handleDeleteIcon();
          ...
          <p>{t('rightClick.rename')}</p>
          <h5></h5>
          <p>{t('rightClick.properties')}</p>
      </div> 
      )}
      {(rightClickDefault && !rightClickIcon && rightClickBin) && (
        <div className='window_rightclick_container'
      ...
      >  
          ...
          >
            {t('rightClick.restore')}
          </p>
          <h5></h5>
          <p >{t('rightClick.cut')}</p>
          <h5></h5>
          <p
            onClick={() => {
              setRightClickBin(false);
