...
export function handleDoubleClickiframe(name, setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe) {
  ...
  switch(name) {
    ...
    case 'AiAgent': 
        setProjectUrl('https://tomatitomkk.github.io/AI_chatbot/'); 
        setBackTrackIe(prev => [...prev, 'https://tomatitomkk.github.io/AI_chatbot/']);
    break;

    case '3dObject': 
        setProjectUrl('https://tomatitomkk.github.io/3d_book/'); 
        setBackTrackIe(prev => [...prev, 'https://tomatitomkk.github.io/3d_book/']);
    break;

    case 'Fortune': 
        setProjectUrl('https://tomatitomkk.github.io/week_fortune/'); 
        setBackTrackIe(prev => [...prev, 'https://tomatitomkk.github.io/week_fortune/']);
    break;

    case 'PixelPic': 
        setProjectUrl('https://tomatitomkk.github.io/Pixel_pic/'); 
        setBackTrackIe(prev => [...prev, 'https://tomatitomkk.github.io/Pixel_pic/']);
    break;
